...
#File location
file = 'C:/Users/Ludovic.SPAETH/Downloads/23.smr'
savedir = 'C:/Users/Ludovic.SPAETH/Downloads'
manip = '23'
...
spike_wfs = extract_spike_waveform(signal, spike_idx,left_width=10,right_width=20)
spike_wfs_indexes = np.arange(-10,20,1)
