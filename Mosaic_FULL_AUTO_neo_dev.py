...
FOLDERS = ['ENR 18-05-2017','ENR 18-05-2017',
...
for NAME,FOLDER,IDX in zip(NAMES,FOLDERS,range(len(NAMES))):
    ...
    savedir = 'U:/01_ANALYSIS/01_BRAVE_NEW_WORLD/AMP_ANALYSIS/00_MAPS/ENR'
    ...
    if SAVING == True:
        plt.savefig(r'%s/%s_Amp_Map_Noise_Hist.png'%(savedir,name))
